...
async function testDesktopCgi2() {
  console.log('=== Testing Desktop CGI Resolution with exportId parameter ===');
  ...
  if (dynamicExportId) {
    ...
    console.log('🔥 Second-step CGI Result with exportId:', JSON.stringify(result, null, 2).slice(0, 1000));
  }
